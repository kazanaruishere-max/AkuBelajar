...
const navItems = {
  super_admin: [
    ...
    { label: 'Tahun Ajaran', href: '/admin/academic-years', icon: 'calendar' },
    { label: 'Kelas', href: '/admin/classes', icon: 'users' },
    { label: 'Mata Pelajaran', href: '/admin/subjects', icon: 'book' },
    { label: 'Pengguna', href: '/admin/users', icon: 'user-plus' },
    { label: 'Notifikasi', href: '/notifications', icon: 'shield' },
  ],
  teacher: [
    { label: 'Dashboard', href: '/dashboard', icon: 'grid' },
    { label: 'Tugas', href: '/teacher/assignments', icon: 'file-text' },
    { label: 'Kuis', href: '/teacher/quizzes', icon: 'help-circle' },
    { label: 'Absensi', href: '/teacher/attendance', icon: 'check-square' },
    { label: 'Notifikasi', href: '/notifications', icon: 'shield' },
  ],
  class_leader: [
    { label: 'Dashboard', href: '/dashboard', icon: 'grid' },
    { label: 'Tugas', href: '/student/assignments', icon: 'file-text' },
    { label: 'Kuis', href: '/student/quizzes', icon: 'help-circle' },
    { label: 'Nilai', href: '/student/grades', icon: 'bar-chart-2' },
    { label: 'Notifikasi', href: '/notifications', icon: 'shield' },
  ],
  student: [
    { label: 'Dashboard', href: '/dashboard', icon: 'grid' },
